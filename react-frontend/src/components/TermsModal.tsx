...
import { termsOfServiceContent } from '../content/privacy-policy';
        ...
        <div className="flex-1 overflow-y-auto p-6">
          ...
          <div className="mb-6 p-4 bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg">
            ...
            <div className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
              <p>
                By using RevStar Wellness Navigator, you agree to use the service for lawful purposes only and
                maintain the security of your account.
              </p>
              <p>
                The App provides educational content and tools but does not replace professional medical or therapeutic advice.
                All content and recommendations are for informational purposes only.
              </p>
              <p>
                We reserve the right to modify these terms and will notify you of significant changes.
